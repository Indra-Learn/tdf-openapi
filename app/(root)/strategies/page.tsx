function Strategies() {
    const strategy_1 = 'strategy 1';

    if (strategy_1) {
        return (
            <>
            <h3 className="mb-2 text-large font-bold dark:text-white">{strategy_1}</h3>
            <h2 className="mb-2 text-3xl font-bold dark:text-white">Strategies:</h2>
...
<div className="md:flex">
    ...
    <div className="p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
        ...
        <p className="mb-2">This is some placeholder content the Profile tab associated content, clicking another tab will toggle the visibility of this one for the next.</p>
    ...
    return (
        <div>No Strategies Available</div>
    )
}
